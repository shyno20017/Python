...
class obj_Spritesheet_Set:
    ...
    def __init__(self, file_names: List[str], width: int, height: int):
        self.sprite_sheets: List[obj_Spritesheet] = [obj_Spritesheet(file_name, width, height) for file_name in file_names]
...
def menu_tile_select(line_config: Dict=None, circle_config: Dict=None, ignore_click: bool=False) -> T_COORDINATE:
    ...
    if line_config is not None:
        ...
        penetrate_creatures = penetrate_creatures if "penetrate_creatures" not in line_config else line_config["penetrate_creatures"]
